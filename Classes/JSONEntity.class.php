...
/*
	...
	@description: Classe parent de tous les modèles (classe entitées) liées a la base de donnée,
	 cette classe est configuré pour agir avec une base Texte plain type JSON, mais il est possible de redefinir ses codes SQL pour l'adapter à un autre SGBD sans affecter 
