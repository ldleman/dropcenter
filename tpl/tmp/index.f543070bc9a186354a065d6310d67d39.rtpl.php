<?php if(!class_exists('raintpl')){exit;}?><?php $tpl = new RainTPL;$tpl_dir_temp = self::$tpl_dir;$tpl->assign( $this->var );$tpl->draw( dirname("header") . ( substr("header",-1,1) != "/" ? "/" : "" ) . basename("header") );?>
		...
		<li>
			<ul>
				<li><figure class="avatar" id="avatar"><img src="./tpl/UnderBlack/../../PHP/action.php?action=openFile&file=<?php echo $value1->avatar;?>"/></figure></li>
		...
		<?php }else{ ?>
			<figure class="avatar"><img src="./tpl/UnderBlack/../../PHP/action.php?action=openFile&file=<?php echo $user->avatar;?>"/></figure><section class="textLogin"><?php echo tt("Connecte en tant que %",array($user->login)); ?> - <a href="php/action.php?action=logout"><?php echo tt("Deconnexion"); ?></a></section>
		<?php } ?>
		</div>
...
<div class="clear"></div>
		...
		<!--*********************-->
<?php if( isset($user) ){ ?>
<div class="fileBloc tooltips" title="Faites glisser des fichiers sur la zone ou cliquez sur celle ci pour evoyer des fichiers">
<div id="dropZone">
